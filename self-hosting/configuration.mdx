---
title: "Configure Timeful: Environment Variables Reference"
...
<ParamField body="VUE_APP_POSTHOG_API_KEY" type="string">
  PostHog project API key. Leave empty to disable server-side PostHog analytics. See also `posthogApiKey` in `config.js` for the frontend-side key.
</ParamField>
