...
sidebarTitle: "Events"
description: "Full reference for all /api/events endpoints: create, edit, respond, delete, duplicate, archive, and fetch calendar availability for groups."
---
...
<ParamField body="when2meetHref" type="string">
...
<ResponseField name="hasResponded" type="boolean">
...
<ResponseField name="creatorPosthogId" type="string">
