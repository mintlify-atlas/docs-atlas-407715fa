...
description: "How Timeful session cookies work, the two OAuth sign-in flows, protected vs. public endpoints, and how to check your auth status."
---
...
- `POST /api/events/:eventId/responded` — mark a remindee as responded
