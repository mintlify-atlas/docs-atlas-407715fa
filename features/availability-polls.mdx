---
title: "Availability Polls: Find the Best Meeting Time"
...
|---|---|---|---|
| `maxCapacityPerSlot` | `*int` | `4` | Maximum number of people who can be marked available for a single time slot. `nil` means unlimited. |
